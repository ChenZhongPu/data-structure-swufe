...
\begin{frame}[fragile]
  ...
  \textbf{Example}: Bob's father is Jack, and he has a sister named Alice. Which data structure can store those names and imply the relationships?
...
\begin{frame}[fragile]
  ...
  \begin{columns}
    ...
    level distance = 1.5cm}, scale=.95, redline/.style = {edge from parent/.style={draw, red}}, blackline/.style={edge from parent/.style={draw, black}}]
  \node [bst] (rootn) {P}
