...
\begin{frame}
    \frametitle{Think \faIcon{lightbulb}}
...
{\large \faIcon{code}} Try to implement this algorithm is Python.
\end{frame}

\begin{frame}[fragile]

\begin{minted}[bgcolor=LightGray, baselinestretch=1, fontsize=\small]{python}
from collections import deque
...
\begin{enumerate}
    ...
    \item \sout{Please elaborate how to use two \texttt{stacks} as a \texttt{queue}; how about the time complexity?  (5 marks)}
\end{enumerate}
\end{frame}
\end{document}