...
\begin{block}{\faIcon{question-circle} Question 1}
    How to get the size of a list in Python?
\end{block}

\begin{block}{\faIcon{question-circle} Question 2}
...
\begin{frame}
    \frametitle{Which One Is Better?}

    \includegraphics[height=.6\paperheight]{week0/box1}%
\includegraphics[height=.6\paperheight]{week0/box2}

\pause

\begin{tikzpicture}
    \node[fill=red!30,blur shadow={shadow xshift=-0.5ex},
    text width=26em,anchor=south west,rounded corners]
    {\faIcon{bell} How your data are organized depends on your applications.};
\end{tikzpicture}
