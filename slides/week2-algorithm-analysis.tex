...
\begin{frame}
	...
	An algorithm in $O(n)$ is always faster than an algorithm in $O(n^3)$.
\end{frame}
...
\begin{frame}
	...
	\begin{alertblock}{Note}
		...
		\begin{itemize}
			\item How to use big O notation to express how complex an algorithm is (in the worst case);
